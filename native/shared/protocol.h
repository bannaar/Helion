...
enum class Command { create, login, chat, profile, state, quit, launch, input, flight, mine, dock, contacts, buy, sell, mission, accept, turnin, upgrade, repair, refuel, outfit, fire, recover, invalid };
struct Request {
