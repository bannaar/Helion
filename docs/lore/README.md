...
| First Ore mission and mining loop | Orion Extraction Group introduction | Implemented mechanically; narrative affiliation pending |
| Station markets and hauling | Meridian-style trade and dynamic economy foundation | Implemented foundation |
| Raiders and combat rewards | Vanta/Red Wake criminal pressure and bounty progression | Combat foundation in active native work |
...
| GalNet news and chat | Simulation events, opportunities, political change, and alien escalation | Implemented foundation |
| Reputation | Standing with powers, local authorities, corporations, and criminal groups | Model expansion pending |
