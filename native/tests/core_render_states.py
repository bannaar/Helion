...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="helion-core-render-") as directory:
        ...
        for state in states:
            ...
            if "draw-calls=4" not in result.stdout or "textures=1" not in result.stdout:
    ...
    print("core render states: normal, mining, target, combat, docked, destroyed, and GalNet passed")
